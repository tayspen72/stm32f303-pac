...
pub struct R(crate::R<TDL2R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TDL2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TDL2R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TDL2R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TDL2R` writer"]
pub struct W(crate::W<TDL2R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TDL2R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TDL2R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TDL2R_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "mailbox data low register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tdl2r](index.html) module"]
pub struct TDL2R_SPEC;
impl crate::RegisterSpec for TDL2R_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tdl2r::R](R) reader structure"]
impl crate::Readable for TDL2R_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [tdl2r::W](W) writer structure"]
impl crate::Writable for TDL2R_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets TDL2R to value 0"]
impl crate::Resettable for TDL2R_SPEC {
    #[inline(always)]
