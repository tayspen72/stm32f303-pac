...
pub struct R(crate::R<TDT1R_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TDT1R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TDT1R_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TDT1R_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TDT1R` writer"]
pub struct W(crate::W<TDT1R_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TDT1R_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TDT1R_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TDT1R_SPEC>) -> Self {
        W(writer)
    }
}
