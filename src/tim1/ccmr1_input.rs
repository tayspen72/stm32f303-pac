...
pub struct IC2PCS_R(crate::FieldReader<u8, u8>);
impl IC2PCS_R {
    pub(crate) fn new(bits: u8) -> Self {
...
#[doc = "Field `IC1PCS` reader - Input capture 1 prescaler"]
pub struct IC1PCS_R(crate::FieldReader<u8, u8>);
impl IC1PCS_R {
    pub(crate) fn new(bits: u8) -> Self {
        IC1PCS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IC1PCS_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
#[doc = "Field `IC1PCS` writer - Input capture 1 prescaler"]
