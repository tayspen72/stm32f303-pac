...
pub struct SRAMEN_R(crate::FieldReader<bool, bool>);
impl SRAMEN_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct ADC34EN_R(crate::FieldReader<bool, bool>);
impl ADC34EN_R {
    pub(crate) fn new(bits: bool) -> Self {
        ADC34EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for ADC34EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
