...
pub struct CANRST_R(crate::FieldReader<bool, bool>);
impl CANRST_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct DAC2RST_R(crate::FieldReader<bool, bool>);
impl DAC2RST_R {
    pub(crate) fn new(bits: bool) -> Self {
        DAC2RST_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DAC2RST_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
