...
pub struct CCR2L_R(crate::FieldReader<u16, u16>);
impl CCR2L_R {
    pub(crate) fn new(bits: u16) -> Self {
        CCR2L_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CCR2L_R {
...
pub struct CCR2H_R(crate::FieldReader<u16, u16>);
impl CCR2H_R {
    pub(crate) fn new(bits: u16) -> Self {
        CCR2H_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CCR2H_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
impl R {
    ...
    #[inline(always)]
    pub fn ccr2l(&self) -> CCR2L_R {
        CCR2L_R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - High Capture/Compare 2 value (on TIM2)"]
    #[inline(always)]
    pub fn ccr2h(&self) -> CCR2H_R {
        CCR2H_R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Low Capture/Compare 2 value"]
    #[inline(always)]
    pub fn ccr2l(&mut self) -> CCR2L_W {
        CCR2L_W { w: self }
    }
    #[doc = "Bits 16:31 - High Capture/Compare 2 value (on TIM2)"]
    #[inline(always)]
    pub fn ccr2h(&mut self) -> CCR2H_W {
        CCR2H_W { w: self }
    }
