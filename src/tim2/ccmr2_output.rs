...
#[doc = "Field `O24CE` reader - Output compare 4 clear enable"]
...
#[doc = "Field `O24CE` writer - Output compare 4 clear enable"]
...
pub struct OC3M_3_R(crate::FieldReader<bool, bool>);
impl OC3M_3_R {
    pub(crate) fn new(bits: bool) -> Self {
...
pub struct OC4M_3_R(crate::FieldReader<bool, bool>);
impl OC4M_3_R {
    pub(crate) fn new(bits: bool) -> Self {
        OC4M_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OC4M_3_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
