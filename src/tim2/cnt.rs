...
pub struct CNT_OR_UIFCPY_R(crate::FieldReader<bool, bool>);
impl CNT_OR_UIFCPY_R {
    pub(crate) fn new(bits: bool) -> Self {
        CNT_OR_UIFCPY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CNT_OR_UIFCPY_R {
...
pub struct CNT_OR_UIFCPY_W<'a> {
    w: &'a mut W,
}
impl<'a> CNT_OR_UIFCPY_W<'a> {
...
impl R {
    ...
    pub fn cnth(&self) -> CNTH_R {
        CNTH_R::new(((self.bits >> 16) & 0x7fff) as u16)
    }
    #[doc = "Bit 31 - if IUFREMAP=0 than CNT with read write access else UIFCPY with read only access"]
    #[inline(always)]
    pub fn cnt_or_uifcpy(&self) -> CNT_OR_UIFCPY_R {
        CNT_OR_UIFCPY_R::new(((self.bits >> 31) & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bits 0:15 - Low counter value"]
