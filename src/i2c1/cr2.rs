...
pub struct SADD8_R(crate::FieldReader<u8, u8>);
impl SADD8_R {
    pub(crate) fn new(bits: u8) -> Self {
        SADD8_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SADD8_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SADD1_R(crate::FieldReader<u8, u8>);
impl SADD1_R {
    pub(crate) fn new(bits: u8) -> Self {
        SADD1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SADD1_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct SADD0_R(crate::FieldReader<bool, bool>);
impl SADD0_R {
    pub(crate) fn new(bits: bool) -> Self {
        SADD0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SADD0_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
