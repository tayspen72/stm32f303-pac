...
pub struct OA1_1_R(crate::FieldReader<u8, u8>);
impl OA1_1_R {
    pub(crate) fn new(bits: u8) -> Self {
        OA1_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA1_1_R {
...
pub struct OA1_8_R(crate::FieldReader<u8, u8>);
impl OA1_8_R {
    pub(crate) fn new(bits: u8) -> Self {
        OA1_8_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for OA1_8_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
