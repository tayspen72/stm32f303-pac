...
pub struct COMP5INSEL_R(crate::FieldReader<u8, u8>);
impl COMP5INSEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        COMP5INSEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMP5INSEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct COMP5INSEL_W<'a> {
    w: &'a mut W,
}
impl<'a> COMP5INSEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
pub struct COMP5_OUT_SEL_R(crate::FieldReader<u8, u8>);
impl COMP5_OUT_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        COMP5_OUT_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for COMP5_OUT_SEL_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct COMP5_OUT_SEL_W<'a> {
    w: &'a mut W,
}
impl<'a> COMP5_OUT_SEL_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl R {
    ...
    #[inline(always)]
    pub fn comp5insel(&self) -> COMP5INSEL_R {
        COMP5INSEL_R::new(((self.bits >> 4) & 0x07) as u8)
    }
    ...
    #[inline(always)]
    pub fn comp5_out_sel(&self) -> COMP5_OUT_SEL_R {
        COMP5_OUT_SEL_R::new(((self.bits >> 10) & 0x0f) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 4:6 - Comparator 5 inverting input selection"]
    #[inline(always)]
    pub fn comp5insel(&mut self) -> COMP5INSEL_W {
        COMP5INSEL_W { w: self }
    }
    #[doc = "Bit 7 - Comparator 5 non inverted input selection"]
    #[inline(always)]
    ...
    #[doc = "Bits 10:13 - Comparator 5 output selection"]
    #[inline(always)]
    pub fn comp5_out_sel(&mut self) -> COMP5_OUT_SEL_W {
        COMP5_OUT_SEL_W { w: self }
    }
    #[doc = "Bit 15 - Comparator 5 output polarity"]
    #[inline(always)]
